"""R04 — Full system with correlation threshold = 0.80 (current best)."""
from _ovr_engine import CDSConfig, run_variant

cfg = CDSConfig(
    binning='supervised', max_bins=6, laplace_alpha=1.0,
    corr_threshold=0.80, features_per_class=18,
...
if __name__ == "__main__":
    run_variant(cfg, label="R04: Full system, corr_threshold=0.80")
