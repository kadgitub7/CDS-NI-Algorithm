"""V3 60/40 Split with full master logging."""
import time
import json
import os
...
if __name__ == "__main__":
    ...
    for i, seed in enumerate(seeds):
        ...
        log_path = LOG_DIR / f"v3_log_60_40_seed{seed}.json"
    ...
    print_report(best_results, label=f"OVR V3 60/40 Split (Best of {len(seeds)} runs)")

    print(f"\nAll logs in: {LOG_DIR}")
    print("Run: python analyze_logs.py output/logs/v3_log_60_40_seed{N}.json")
