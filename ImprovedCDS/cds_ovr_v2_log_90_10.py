"""90/10 Split with full master logging.

Writes a master JSON log to output/logs/log_90_10_seed{seed}.json
...
if __name__ == "__main__":
    ...
    for i, seed in enumerate(seeds):
        ...
        log_path = LOG_DIR / f"log_90_10_seed{seed}.json"
    ...
    print_report(best_results, label=f"OVR V2 90/10 Split (Best of {len(seeds)} runs)")

    print(f"\nAll logs in: {LOG_DIR}")
    print("Run: python analyze_logs.py output/logs/log_90_10_seed{N}.json")
