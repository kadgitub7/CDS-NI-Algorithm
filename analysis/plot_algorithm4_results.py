...
def main():
    ...
    parser.add_argument('--data-path', default=os.path.join(_REPO_ROOT, 'data', 'arrhythmia.data'), help='Path to arrhythmia.data')
    parser.add_argument('--max-users', type=int, default=None, help='Maximum users to process for LOOCV')
    parser.add_argument('--output-dir', default=os.path.join(_REPO_ROOT, 'output', 'graphs'), help='Directory to save plots')
